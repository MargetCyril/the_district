...
if ($libelle == Null || $img == Null || $description == Null || $prix == Null || $categorie == Null || $active == Null) {
...
try {
    $requete = $db->prepare("INSERT INTO plat (libelle, description, prix, image, id_categorie, active) VALUES (:libelle, :description, :prix, :img, :categorie, :active);");
